...
public class ApplicationSceneController extends SceneController {
	...
	@FXML
	private final LineChart<String,Number> historicalReportGraph;

	@FXML
	protected final TextField histReportView_lat;

	@FXML
	protected final TextField histReportView_long;

	@FXML
	protected final TextField histReportView_year;
